package Gongbok_BE.Gongbok.auth.oauth2.service;

import Gongbok_BE.Gongbok.auth.oauth2.domain.CustomOAuth2User;
import Gongbok_BE.Gongbok.auth.oauth2.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Member createdMember = getUser(extractAttributes, socialType); // getClient() 메소드로 User 객체 생성 후 반환
